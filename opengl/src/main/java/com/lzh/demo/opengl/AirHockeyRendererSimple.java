...
public class AirHockeyRendererSimple implements GLSurfaceView.Renderer {
    ...
    public AirHockeyRendererSimple(Context context) {
        mContext = context;
        //设计坐标
...
//        };
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        if (ShaderHelper.validateProgram(program)) {
            MLog.d(MLog.TAG_OPENGL, "AirHockeyRendererSimple->onSurfaceCreated 程序验证通过");
        } else {
            MLog.d(MLog.TAG_OPENGL, "AirHockeyRendererSimple->onSurfaceCreated 程序验证失败");
        }
