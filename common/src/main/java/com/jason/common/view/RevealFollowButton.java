 ...
 * https://github.com/zgzczzw/ZHFollowButton/blob/master/app/src/main/java/com/zgzczw/zhfollowbutton/RevealFollowButton.java
 */
public class RevealFollowButton extends FrameLayout {
    public static final String TAG = RevealFollowButton.class.getSimpleName();
