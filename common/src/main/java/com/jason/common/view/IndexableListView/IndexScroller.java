...
public class IndexScroller {
    ...
    private boolean autoShowAndHide = false;
    ...
    public IndexScroller(Context context, ListView lv) {
        ...
        mIndexbarWidth = 20 * mDensity;//20dp
        mIndexbarMargin = 10 * mDensity;//10dp
        mPreviewPadding = 5 * mDensity;//5dp
    }

    public void draw(Canvas canvas) {
        if (mState == STATE_HIDDEN) {
            MLog.d(MLog.TAG_INDEXABLELV,TAG+"->"+"draw STATE_HIDDEN");
            return;
        }else {
            MLog.d(MLog.TAG_INDEXABLELV,TAG+"->"+"draw STATE NOT HIDDEN");
        }
    ...
    public void setAutoShowAndHide(boolean autoShowAndHide) {
        this.autoShowAndHide = autoShowAndHide;
    }
